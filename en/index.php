...
<head>
<meta charset="UTF-8">
  <title>When is the best time for you? MAKER</title>
...
<body> 
<div id="h1box">
<h1>When is the best time for you? MAKER</h1></div>
<input id="datetimepicker" type="text" >
<div class="textarea_box">
<textarea id="result">When is the best time for you?</textarea>
...
$('.reset_btn').click(function() {
    $("#result").val("When is the best time for you?");
    });
});
</script>
